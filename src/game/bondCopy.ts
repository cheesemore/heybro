...
/** 与 battleBonds 中阈值一致：3 / 6 / 9 数值档，12 终极档 */
export const BOND_TIER_THRESHOLDS = [3, 6, 9, 12] as const;
...
/**
 * 与代码一致的中文说明（3/6/9 为数值羁绊，12 为职业终极）。
 */
...
const BOND_FULL_DESC: Record<AllyClass, Record<BondTierThreshold, string>> = {
  warrior: {
    ...
    9: '【九羁绊】战士层数之和≥9：每名战士在上一档基础上，生命与攻击再+70%。',
    12:
      '【十二羁绊】战士层数之和≥12：每名战士获得「兽人韧性」——受敌方攻击时更易触发格挡（伤害减半）；未达十二羁绊时仅对远程攻击者格挡，达成后近战与远程均可格挡。十二羁绊下格挡成功时，有 30% 概率以自身攻击力对攻击者造成一次反击伤害。',
  },
  mage: {
    3: '【三羁绊】场上法师层数之和≥3：每名法师生命与攻击+30%。',
    6: '【六羁绊】法师层数之和≥6：每名法师在上一档基础上，生命与攻击再+50%。',
    9: '【九羁绊】法师层数之和≥9：每名法师在上一档基础上，生命与攻击再+70%。',
    12:
      '【十二羁绊】法师层数之和≥12：周期性在敌方阵型落下「流星雨」，对大范围敌人造成伤害，数值为当时场上存活法师攻击力之和；若本局拥有「超级法师」策略，流星雨可暴击。',
  },
  priest: {
    3: '【三羁绊】场上牧师层数之和≥3：全队友方单位（含牧师）生命与攻击+15%。',
    6: '【六羁绊】牧师层数之和≥6：全队在上一档基础上，生命与攻击再+25%。',
    9: '【九羁绊】牧师层数之和≥9：全队在上一档基础上，生命与攻击再+35%。',
    12:
      '【十二羁绊】牧师层数之和≥12：牧师治疗量翻倍；牧师在攻击最近敌人的同时，仍可治疗血量偏低的队友（不受常规治疗距离限制）。',
  },
  archer: {
    3: '【三羁绊】场上射手层数之和≥3：每名射手生命与攻击+30%。',
    6: '【六羁绊】射手层数之和≥6：每名射手在上一档基础上，生命与攻击再+50%。',
    9: '【九羁绊】射手层数之和≥9：每名射手在上一档基础上，生命与攻击再+70%。',
    12:
      '【十二羁绊】射手层数之和≥12：每名射手射程+150；每次普攻有 30% 概率立刻追加一箭（可再次暴击并享受神器等加成）。',
  },
  knight: {
    3: '【三羁绊】场上骑士层数之和≥3：每名骑士生命与攻击+30%。',
    6: '【六羁绊】骑士层数之和≥6：每名骑士在上一档基础上，生命与攻击再+50%。',
    9: '【九羁绊】骑士层数之和≥9：每名骑士在上一档基础上，生命与攻击再+70%。',
    12:
      '【十二羁绊】骑士层数之和≥12：骑士冲锋过程中无敌；受到致命伤害时，若有保留次数，会以约 12% 最大生命存活并向最近敌人发动濒死冲锋，冲锋命中伤害提高。骑士当前生命越低，普通攻击伤害越高。',
  },
};
