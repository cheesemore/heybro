...
/** 与 battleBonds 中阈值一致：3 / 6 / 10 数值档，15 终极档，25 极巨化档 */
export const BOND_TIER_THRESHOLDS = [3, 6, 10, 15, 25] as const;
...
const BOND_FULL_DESC: Record<AllyClass, Record<BondTierThreshold, string>> = {
  warrior: {
    ...
    25: '【二十五羁绊】战士层数之和≥25：进入战斗时，随机 3 名战士获得「极巨化」。',
  },
  mage: {
    ...
    25: '【二十五羁绊】法师层数之和≥25：进入战斗时，随机 3 名法师获得「极巨化」。',
  },
  priest: {
    ...
    25: '【二十五羁绊】牧师层数之和≥25：进入战斗时，随机 3 名牧师获得「极巨化」。',
  },
  archer: {
    ...
    25: '【二十五羁绊】射手层数之和≥25：进入战斗时，随机 3 名射手获得「极巨化」。',
  },
  knight: {
    ...
    25: '【二十五羁绊】骑士层数之和≥25：进入战斗时，随机 3 名骑士获得「极巨化」。',
  },
};
