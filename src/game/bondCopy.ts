...
const BOND_FULL_DESC: Record<AllyClass, Record<BondTierThreshold, string>> = {
  warrior: {
    ...
    21: '【二十一羁绊】战士层数之和≥21：进入战斗时，随机 3 名战士获得「极巨化」。',
  },
  mage: {
    ...
    21: '【二十一羁绊】法师层数之和≥21：进入战斗时，随机 3 名法师获得「极巨化」。',
  },
  priest: {
    ...
    21: '【二十一羁绊】牧师层数之和≥21：进入战斗时，随机 3 名牧师获得「极巨化」。',
  },
  archer: {
    ...
    21: '【二十一羁绊】射手层数之和≥21：进入战斗时，随机 3 名射手获得「极巨化」。',
  },
  knight: {
    ...
    21: '【二十一羁绊】骑士层数之和≥21：进入战斗时，随机 3 名骑士获得「极巨化」。',
  },
};
